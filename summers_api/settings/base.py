...
Generated by 'django-admin startproject' using Django 4.0.3. For more
information on this file, see
https://docs.djangoproject.com/en/4.0/topics/settings/ Forof
https://docs.djangoproject.com/en/4.0/ref/settings/ settings and their
values, see
"""
import json
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [(env("REDIS_HOST_DOMAIN"), 6379)],
        },
    },
}
...
AWS_USE_S3_STATIC = env.bool("AWS_USE_S3_STATIC", False)
...
# Tube2drive
STORE_TUBE2DRIVE_LOCAL = env.bool("STORE_TUBE2DRIVE_LOCAL", False)
TUBE2DRIVE_LOCAL_FOLDER = BASE_DIR / "data/tube2drive/videos"
DOWNLOAD_BEST_QUALITY = env.bool("DOWNLOAD_BEST_QUALITY", False)
